    ...
    <div className={c.questionWrapper}>
      ...
      <div className={c.lineTwoAndThreeQuestionTextBlock}>
        ...
        <div className={c.questionHeader}>
          <div className={c.questionHeader_Navlink}>{props.props.heading}</div>
        </div>
      ...
      <div className={c.lineFourLikeAndAvatarAndName}>
        <div className={c.likeBlock}>
          <div
            ...
            onClick={() => {
              props.putLike(props.props._id_post, 'QUESTION')
            }}
          >
            <LikeSVG isLike={props.isLikeQ} />
          </div>
          <div className={c.likeCount}>{props.props.question_likes_count}</div>
        </div>
        <button
          ...
          onClick={() => {
            props.textFieldState
              ...
              : props.showTextField(true)
            console.log(props.textFieldState)
          }}
        >
      ...
      {props.textFieldState ? (
        <AddComment
          type="REPLY-ON-QUESTION"
          id="AddSingle"
          idForSend={props.props._id_post}
